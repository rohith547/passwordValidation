...
public class StringDocumentSearchTest {
	...
	@Test
	public void testStringDocumentSearchPerformance() throws IOException{
		SearchPattern sp = new StringDocumentSearch();
        ...
        System.out.println("String Search Algorithm to Process 2 million searches is "+elapsedTime + " Milliseconds");
	}
